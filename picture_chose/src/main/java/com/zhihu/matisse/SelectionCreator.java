...
public final class SelectionCreator {
    ...
    public void forResult(int requestCode) {
        ...
        if (isOnlyCapture) {
            if (mMediaStoreCompat == null) {
                throw new RuntimeException("Don't forget to set MediaStoreCompat.");
            }
            if (mSelectionSpec.captureStrategy == null)
                throw new RuntimeException("Don't forget to set CaptureStrategy.");
            mMediaStoreCompat.setCaptureStrategy(mSelectionSpec.captureStrategy);
    ...
    public SelectionCreator setMediaStoreCompat(MediaStoreCompat mMediaStoreCompat) {
        this.mMediaStoreCompat = mMediaStoreCompat;
        return this;
    }

    private boolean isOnlyCapture = false;

    public SelectionCreator setOnlyCapture(boolean onlyCapture) {
