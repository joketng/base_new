...
public class Spring {
    ...
    // unique id for the spring in the deviceType
    ...
    /**
     * Check if this spring should be advanced by the deviceType.  * The rule is if the spring is
     * currently at rest and it was at rest in the previous advance, the deviceType can skip this spring
     *
     * @return should the deviceType process this spring
     */
