...
public class ViewDragHelper {
    ...
    public static abstract class Callback {
         ...
         * be clamped to deviceType minimums or maximums.
         * <p>
     ...
     * parent view's coordinate deviceType. If there is no captured view this method
     * will return false.
     *
     * @param x X position to test in the parent's coordinate deviceType
     * @param y Y position to test in the parent's coordinate deviceType
     ...
     * coordinate deviceType. The child order is determined using
