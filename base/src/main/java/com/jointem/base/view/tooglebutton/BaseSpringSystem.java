 ...
 * In addition to listening to physics events on the individual Springs in the deviceType, listeners
...
public class BaseSpringSystem {
    ...
    /**
     * check if the deviceType is idle
     *
     * @return is the deviceType idle
     */
    ...
    /**
     * update the springs in the deviceType
     *
    ...
    /**
     * loop the deviceType until idle
     */
     ...
     * active springs on this deviceType and start the iteration if the deviceType was idle before this call.
     *
